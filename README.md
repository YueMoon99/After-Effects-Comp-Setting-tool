...
## 📄 LicenseThis project is open-source under the MIT License with an additional restriction: Resale or commercial exploitation of this script without explicit permission from the author is prohibited.
